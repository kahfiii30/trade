    ...
    return (
      <div className="flex flex-col gap-1.5 w-full">
        ...
        <select
          ref={ref}
          className={cn(
            'appearance-none bg-black/30 border border-glass-border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-accent-cyan/50 focus:ring-1 focus:ring-accent-cyan/30 focus:bg-black/50 transition-all duration-300 text-gray-100 shadow-inner',
